...
echo $ROOT $TAG $DIR
curl -R -# -k -L -o $DIR/java_natives_$TAG.tar.gz.download -z $DIR/java_natives_$TAG.tar.gz https://github.com/tanjelly/openrasp-v8/releases/download/$TAG/java_natives.tar.gz
